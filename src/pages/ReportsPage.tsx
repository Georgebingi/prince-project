...
export function ReportsPage() {
  ...
  return <Layout title="Analytics & Reports">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 print:grid-cols-2 print:gap-4">
          <Card>
            ...
            <div className="h-64 flex items-end justify-between px-4 gap-2">
              ...
              return <div key={type} className="flex flex-col items-center gap-2 flex-1">
                    <div className="relative w-full flex flex-col items-center">
                      <span className="text-xs font-bold text-slate-700 mb-1">
                        {count}
                      </span>
                      <div className={`w-full rounded-t-md ${colors[type]} opacity-80 hover:opacity-100 transition-opacity print:bg-slate-800`} style={{
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              count: cases.filter(c => c.status === 'Pending Judgment').length,
              color: 'bg-amber-500'
            }, {
              label: 'Review',
              ...
              label: 'Other',
              count: cases.filter(c => !['In Progress', 'Pending Judgment', 'Review', 'Filed'].includes(c.status)).length,
              color: 'bg-slate-400'
                  ...
                  <div className="flex-1 bg-slate-100 rounded-full h-8 overflow-hidden print:border print:border-slate-200">
                    <div className={`${item.color} h-full flex items-center justify-end px-3 text-white text-sm font-bold transition-all duration-500 print:bg-slate-700`} style={{

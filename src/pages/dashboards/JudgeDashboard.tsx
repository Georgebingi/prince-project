...
export function JudgeDashboard() {
  ...
  const pendingJudgment = myCases.filter(
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card noPadding>
              ...
              <div className="p-6">
                ...
                {selectedCase &&
                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg animate-in fade-in slide-in-from-top-2 duration-200">
                    {(() => {
                    const selected = myCases.find(
                      (c) => c.id === selectedCase
                    );
                    return selected ?
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          ...
                          onClick={() => handleViewDetails(selected.id)}>
                            ...
                            <Button
                          size="sm"
                          onClick={() => handleOpenCase(selected.id)}>
